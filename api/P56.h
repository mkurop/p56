...
class P56 {
  ...
  double af = 0;  /*< active speech factor 0..1 (fraction of speech file
...
public:
   ...
   * @param [in] samplingRateInHz sampling rate of the input file (defaults to
   * 8kHz)
   * @param [in] nBits number of bits per sample
   */
  P56(double samplingRateInHz = 8000.0, double nBits = 16.0)
      : samplingRateInHz(samplingRateInHz), nBits(nBits){};
  virtual ~P56();
  /**
